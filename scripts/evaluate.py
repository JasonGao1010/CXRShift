...
def compute_metrics(
    ...
    """Compute threshold and ranking metrics from one fixed prediction vector."""
...
def expected_calibration_error(
    ...
    *,
    ...
    """Compute equal-width ECE while retaining empty bins in the specification."""
...
def evaluate(args: argparse.Namespace) -> dict[str, Any]:
    """Evaluate one checkpoint and export aligned per-image probabilities."""
    import timm
    import torch

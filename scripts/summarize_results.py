#!/usr/bin/env python3
"""Aggregate CXRShift predictions with explicit grouped estimands."""
...
def metrics(
    ...
    """Compute the fixed-threshold and ranking estimands used in the report."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-json", type=Path, default=Path("results/CXRShift__main-summary.json")
    )
    parser.add_argument(
        "--output-csv", type=Path, default=Path("results/CXRShift__main-summary.csv")
    )

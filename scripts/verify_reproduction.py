#!/usr/bin/env python3
"""Compare a clean CXRShift rebuild with the published reference evidence."""
...
def main() -> int:
    ...
    if not integrity.get("ok"):
        failures.append("Dataset or evaluation integrity audit failed")
    if not (work / "results/CXRShift__source-analysis.json").is_file():
        failures.append("Source-separability analysis is missing")
